...
export default function LoginForm() {
  ...
  return (
    <div className="mt-24 mb-10 flex h-auto  w-full flex-col items-center justify-center rounded-xl border-b-4  border-t-4 border-green-400 bg-white shadow-xl shadow-slate-300 md:w-full">
          ...
          <form onSubmit={handleSubmit} className="my-10 w-[80%]">
            <div className="flex flex-col space-y-5">
                ...
                <div>
                  <label for="remember" className="mb-2">
                    <input
                      type="checkbox"
                      id="remember"
                      className="h-3 w-3 border-slate-200 focus:bg-green-600"
                    />
              ...
              <button
                ...
                className="inline-flex w-full items-center justify-center space-x-2 rounded-lg border-green-500 bg-green-400 py-3 font-medium text-white hover:bg-green-500 hover:shadow"
              >
                <svg
