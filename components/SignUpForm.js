...
export default function SignUpForm() {
  ...
  return (
    <div className="mt-8 flex h-auto w-[90%] flex-col items-center justify-center rounded-xl border-b-4 border-t-4  border-green-400 bg-white shadow-xl shadow-slate-300 md:mb-10 md:ml-10 md:w-[70%]">
      <div className="relative mt-2 flex h-12 w-12  md:h-16 md:w-32">
        <Image src={logo} layout="fill" objectFit="contain" />
      </div>

      <p className="my-3 text-slate-500">CRÉEZ VOTRE COMPTE 👋</p>
      ...
      <Formik
        ...
        validate={(values) => {
          ...
          //   errors.accountType = 'Please check one'
          // }
