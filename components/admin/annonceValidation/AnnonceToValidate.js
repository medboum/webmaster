...
export default function AnnonceToValidate({
  photo,
  details,
  description,
  options,
  ...
  return (
    <>
      <tr>
        ...
        <td className="max-w-[260px] border-b border-gray-200 bg-white px-2 py-5 text-sm">
          <p className="whitespace-no-wrap text-center font-medium tracking-wide text-gray-900">
            {description}
          </p>
        </td>
